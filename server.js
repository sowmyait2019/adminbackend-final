...
const connectToDB = async () => {
  try {
    await mongoose.connect('mongodb+srv://sowmya123:1234@cluster0.od7q3za.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
...
// Route to fetch event data
app.get('/orders/book-order', async (req, res) => {
  try {
